    ...
    this.myService.trainingApprovals().subscribe(data=>
      {
        ...
        this.Requested=_.where(this.myData,{accept:false,rejected:false,mentorId:4});


        this.Approved=_.where(this.myData,{accept:true,rejected:false,mentorId:4});

        this.Declined=_.where(this.myData,{accept:false,rejected:true,mentorId:4});
